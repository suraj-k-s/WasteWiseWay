    ...
    <jsp:useBean class="DB.ConnectionClass" id="con"></jsp:useBean>
        ...
        <body>
            ...
            <%
                     ...
                     String selqry = "select u.user_longitude as longitude,u.user_latitude as latitude from tbl_wasterequest wr inner join tbl_user u on u.user_id=wr.user_id where wr.employee_id='" + session.getAttribute("eid") + "'";
