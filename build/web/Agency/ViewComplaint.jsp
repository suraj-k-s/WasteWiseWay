...
<html>
    ...
    <body>
        ...
        <table border="1" align="center">
            ...
            <%
                String select = "select * from tbl_complaint c inner join tbl_complainttype ct on ct.complainttype_id=c.complainttype_id inner join tbl_user u on u.user_id=c.user_id inner join tbl_agency a on a.place_id=u.place_id  where complaint_status='0' and agency_id='"+session.getAttribute("agid")+"' ";
