...
//checking if request cotains multipart data
            ...
            if (isMultipart) {
                ...
                String InsQry = "insert into tbl_employee(employee_name,employee_email,employee_address,employee_contact,employee_gender,place_id,employee_photo,employee_proof,employee_password,employee_doj,supervisor_id)"
                        + "values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + value[4] + "','" + value[7] + "','" + photo + "','" + proof + "','" + value[8] + "',curdate(),'"+session.getAttribute("supid")+"')";
