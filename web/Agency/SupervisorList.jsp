...
<html>
    ...
    <body>
        ...
        <table border="1" align="center">
            ...
            <%
                String select = "select * from tbl_supervisor s inner join tbl_place p on p.place_id = s.place_id inner join tbl_district d on p.district_id = d.district_id inner join tbl_type t on p.type_id = t.type_id where s.agency_id='"+session.getAttribute("agid")+"'";
