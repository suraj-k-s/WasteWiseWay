...
<html>
    ...
    <body>
        ...
        String up = "update tbl_wasterequest set employee_id='"+request.getParameter("asid")+"', wastereq_status=1 where wastereq_id='"+session.getAttribute("wid")+"' ";
      // out.print(up);
        con.executeCommand(up);
        response.sendRedirect("viewuserwastereq.jsp");
        }
          if(request.getParameter("rsid")!=null){
        String up1 = "update tbl_rdwaste set employee_id='"+request.getParameter("rsid")+"', rdwaste_status=1 where rdwaste_id='"+session.getAttribute("wid")+"' ";
      // out.print(up);
        ...
        <table border="1" align="center">
            ...
            <tr>
                ...
                <td><a href="AssignEmployee.jsp?asid=<%=rs.getString("employee_id")%>&wid=<%=session.getAttribute("wid")%>">Assign For Waste Request</a>
               || <a href="AssignEmployee.jsp?rsid=<%=rs.getString("employee_id")%>&wid=<%=session.getAttribute("wid")%>">Assign For Road Request</a></td>
