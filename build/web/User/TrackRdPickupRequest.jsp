    ...
    <body>
        ...
        <table border="1" align="center">
            ...
            <%//out.print(session.getAttribute("usid"));
                String select = "select * from tbl_rdwaste r inner join tbl_user u on u.user_id=r.user_id inner join tbl_place p on p.place_id=r.place_id inner join tbl_agency ag on ag.place_id=p.place_id inner join tbl_district d on d.district_id=p.district_id inner join tbl_type t on t.type_id=p.type_id where u.user_id ='"+session.getAttribute("usid")+"' ";
