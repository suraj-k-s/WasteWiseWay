...
//checking if request cotains multipart data
            ...
            if (isMultipart) {
                ...
                String selQry = "select * from tbl_agency where place_id='" + value[6] + "'";
                ResultSet rs = obj.selectCommand(selQry);
                if (rs.next()) {
        %> 
        <script type="text/javascript">
            alert("Agancy Alredy Exist in This place");
            setTimeout(function() {
                window.location.href = '../../Admin/AgencyRegisteration.jsp'
            }, 40);
        </script>
        <%
        } else {
                    
            String InsQry = "insert into tbl_agency(agency_name,agency_email,agency_address,agency_contact,place_id,agency_logo,agency_proof,agency_password,agency_doj)"
                    + "values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + value[6] + "','" + logo + "','" + proof + "','" + value[7] + "',curdate())";
