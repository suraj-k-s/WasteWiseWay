    ...
    <body>
        ...
        <div id="tab" align="center">
            ...
            <table border="1" align="center">
                ...
                <%
                    String select = "select * from tbl_wasterequest w inner join tbl_user u on u.user_id=w.user_id where employee_id='" + session.getAttribute("eid") + "'";
    //out.print(select);
                ...
                <tr>
                    ...
                    <td><a href="Collect.jsp?wid=<%=rs.getString("user_id")%>">Collect</a></td>
