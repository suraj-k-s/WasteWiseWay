    ...
    <body>
        ...
        <%
          if (request.getParameter("btnsave") != null) {
                    ...
                    String up = "update tbl_employee set employee_name='" + request.getParameter("txt_name") + "' ,employee_email='" + request.getParameter("txt_email") + "' ,employee_contact='" + request.getParameter("txt_contact") + "' ,employee_address='" + request.getParameter("txt_address") + "' where employee_id='" +session.getAttribute("eid")+ "' ";
              con.executeCommand(up);}
          %>
        <%
            
                String sel="select * from tbl_employee where employee_id='"+session.getAttribute("eid")+"'";
                //out.print(sel);
