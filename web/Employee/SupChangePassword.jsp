...
<html>
    <head>
        ...
        if(request.getParameter("btnsave")!=null)
        {
            ...
            String selQry="select * from tbl_employee where employee_id='"+session.getAttribute("supid")+"'";
            ...
            if(cPassword.equals(currentPassword))
            {
                ...
                {
                    String upQry = "update tbl_employee set employee_password='"+nPassword+"' where employee_id='"+session.getAttribute("supid")+"'";
                    out.println(upQry);
